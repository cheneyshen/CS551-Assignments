...
int req_inodeviewer(endpoint_t fs_e, ino_t inode);
int req_rcmkdir(endpoint_t fs_e, ino_t inode);
int req_damageinode(endpoint_t fs_e, ino_t pinode, ino_t finode, char* fullpath);
int req_restoreinode(endpoint_t fs_e, ino_t pinode, char* fullpath);

int do_inodeviewer(void);
int do_rcmkdir(void);
int do_damageinode(void);
int do_restoreinode(void);
#endif
